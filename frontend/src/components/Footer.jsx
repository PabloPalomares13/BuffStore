        ...
        <div className='bg-black '>
                ...
                style={{ backgroundImage: `url(${buffarcade})`, fontFamily: '"Urbanist", sans-serif' }}>
                    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-6 gap-8 md:gap-12">
                        ...
                        <div className="lg:col-span-3 space-y-6">
                            <a href="https://prebuiltui.com" className="block">
                                <img src={logo} alt="buffstore" className="h-20 w-20" />
                            </a>
                    ...
                    <div className="max-w-7xl mx-auto mt-12 pt-4 border-t border-neutral-700 flex justify-between items-center">
                        <p className="text-neutral-400 text-sm">© 2026 Buff Store Proyect</p>
                        <p className='text-sm text-neutral-400'>All right reserved.</p>
                    </div>
                    <div className="relative">
                        <h3 className="text-center font-extrabold leading-[0.7] text-transparent text-[clamp(3rem,15vw,15rem)] [-webkit-text-stroke:1px_#ffffff] mt-6 tracking-wider" >
                            BUFFSTORE
                        </h3>
